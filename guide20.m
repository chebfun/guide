...
% it is the extension of Chebfun2 to the polar setting, designed to accurately 
% and efficiently perform over 100 commands with functions on the disk, 
...
% the two are conceptually closely related. 
