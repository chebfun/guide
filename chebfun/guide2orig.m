...
% handle it to high accuracy.  Chebfun2 can do the job well too -- see
% the Chebfun2 guide.
...
% done by the chebfunpref command, as described in Chapter 8.  For this
...
% due to Nick Hale and Alex Townsend [Hale & Townsend 2013].   To start with, suppose we
