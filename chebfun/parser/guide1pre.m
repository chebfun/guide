...
% The *|<#CHEBDOC:chebfun chebfun>|* command constructs a chebfun from a
...
% *|<#MATLABDOC:methods methods>|*:
  methods chebfun

%%
% To find out what a command does, you can browse the 
% <#CHEBDOC Chebfun documentation> or use *|<#MATLABDOC:help help>|*:
  help chebfun/chebpoly

%%
% Most of the commands in the list exist in ordinary MATLAB(R);
% some exceptions are
% |<#CHEBDOC:domain domain>|,
% |<#CHEBDOC:restrict restrict>|,
% |<#CHEBDOC:chebpoly chebpoly>|,
% |<#CHEBDOC:defineInterval defineInterval>|, and
% |<#CHEBDOC:remez remez>|.
% We have already seen
% |<#CHEBDOC:length length>| and
% |<#CHEBDOC:sum sum>| in action.
% In fact we have already seen
% |<#CHEBDOC:subsref subsref>| too,
...
% |<#CHEBDOC:times times>|,
% |<#CHEBDOC:plus plus>|,
% |<#CHEBDOC:power power>|, and
% |<#CHEBDOC:rdivide rdivide>|,
...
% *|<#CHEBDOC:chebpref splitting off>|*
...
% *|<#CHEBDOC:chebpref splitting on>|*:
  f = chebfun('abs(x-.3)', 'splitting', 'on');

%%
% The *|<#CHEBDOC:length length>|* command reveals that |f| is defined by
...
%%
% We can see the structure from another angle with *|<#MATLABDOC:disp disp>|*:
  disp(f)
...
% For example, the *|<#CHEBDOC:abs abs>|* command first finds zeros
...
% *|<#CHEBDOC:max max>|* command, leading to a chebfun with 13 pieces:
  f = sin(20*x);
  g = exp(x-1);
  h = max(f, g);
  plot(h)
...
% detection or |<#CHEBDOC:chebpref splitting>| feature, when it is turned
...
% |<#CHEBDOC:chebpref splitting on>|, we end up
...
%%
% In a Chebfun computation, |<#CHEBDOC:chebpref splitting>| can be turned
% on and off freely to handle different functions appropriately.
% The default or "factory" value
% is |<#CHEBDOC:chebpref splitting off>|; see <guide8.html Chapter 8>.
...
% (see *|<#CHEBDOC:chebpref chebpref>|* for details):
%%
...
% |<#MATLABDOC:open open>(<#MATLABDOC:publish publish>('guide1'))|.
