...
%% 2.1 |sum|
% We have seen that the *|<#CHEBDOC:sum sum>|* command returns the definite
...
% |<#MATLABDOC:erf erf>| code is the fastest:
  tic, erf(1), toc
...
% because of the absolute value, which with |<#CHEBDOC:chebpref splitting on>|
...
% of |<#CHEBDOC:chebpref splitting off>|:
...
%%
% With |<#CHEBDOC:chebpref splitting on>|, we get a much shorter chebfun
...
% *|<#CHEBDOC:chebpref minsamples>|* as described in <guide8.html Section 8.6>.
...
% A special case of an integral is the *|<#CHEBDOC:norm norm>|* command,
...
% <#MATHWORLD:SoldnersConstant Soldner's constant>.
...
%%
% The <#MATHWORLD:PrimeNumberTheorem Prime Number Theorem>
...
% *|<#CHEBDOC:mean mean>|*, *|<#CHEBDOC:std std>|*, and *|<#CHEBDOC:var var>|*
...
%%
% Thanks to the delta functions, |<#CHEBDOC:cumsum cumsum>| and
% |<#CHEBDOC:diff diff>| are essentially inverse operations.
...
% |<#CHEBDOC:diff diff>|.  Thus for example,
  f = chebfun('1./(1+x.^2)');
  g = diff(f,4); plot(g)
...
% the flag *|<#CHEBDOC:chebfun 'vectorize'>|* to construct a chebfun from
...
% |<#MATLABDOC:dblquad dblquad/quadl>|
...
% done by the *|<#CHEBDOC:chebpref chebpref>|* command, as described in
...
% polynomial |*<#CHEBDOC:legpoly legpoly>*(4)|, which
% can be obtained from the Chebfun command *|<#CHEBDOC:legpts legpts>|*,
% and if two output arguments are requested, |<#CHEBDOC:legpts legpts>|
...
% *|<#CHEBDOC:legpoly legpoly>|* and *|<#CHEBDOC:legpts legpts>|.*
% For Chebyshev polynomials, Chebyshev points, and
% Clenshaw-Curtis quadrature, use *|<#CHEBDOC:chebpoly chebpoly>|*
% and *|<#CHEBDOC:chebpts chebpts>|* and the built-in
% Chebfun commands such as |<#CHEBDOC:sum sum>|. A third variant is also
% available: for Jacobi polynomials, Gauss-Jacobi points, and Gauss-Jacobi
% quadrature, see *|<#CHEBDOC:jacpoly jacpoly>|*
% and *|<#CHEBDOC:jacpts jacpts>|.*
