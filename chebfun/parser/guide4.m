...
% *|<../../chebdoc/doc/chebpoly_DOC.html chebpoly>(N)|* returns a chebfun corresponding to $T_N$,
% and *|<../../chebdoc/doc/poly_DOC.html poly>|* returns coefficients in the monomial basis
...
%%
% Note that that output of |<../../chebdoc/doc/poly_DOC.html poly>| follows the pattern for
% MATLAB(R)'s standard |<http://www.mathworks.com/help/matlab/ref/poly.html poly>|
...
% (<http://mathworld.wolfram.com/LipschitzFunction.html Lipschitz continuity> is
...
% We have just seen that the command |<../../chebdoc/doc/chebpoly_DOC.html chebpoly>(N)|
% returns a chebfun corresponding to the Chebyshev polynomial $T_N$.
% Conversely, if |f| is a chebfun, then |<../../chebdoc/doc/chebpoly_DOC.html chebpoly>(f)|
...
%%
% Like |<../../chebdoc/doc/poly_DOC.html poly>|, |<../../chebdoc/doc/chebpoly_DOC.html chebpoly>| returns a
...
%%
% If we apply |<../../chebdoc/doc/chebpoly_DOC.html chebpoly>| to a function that is not
...
%%
% By using |<../../chebdoc/doc/poly_DOC.html poly>| we can print the coefficients of such
...
% means of a command of the form |<../../chebdoc/doc/chebfun_DOC.html chebfun>(...,N)|.
...
% precision. We can confirm this by using |<../../chebdoc/doc/chebpref_DOC.html splitting on>|
...
% Now the straight line appears on the |<http://www.mathworks.com/help/matlab/ref/semilogy.html semilogy>|
% axes rather than the |<http://www.mathworks.com/help/matlab/ref/loglog.html loglog>| axes, revealing
...
% Chebfun makes this possible with the command *|<../../chebdoc/doc/remez_DOC.html remez>|*,
...
% from |<../../chebdoc/doc/remez_DOC.html remez>| returns the error as well as the polynomial.
%%
% ????? FIXME: |remez| not implemented
%
%    [p,err] = remez(f,20);
...
%%
% Chebfun |<../../chebdoc/doc/remez_DOC.html remez>| command can compute certain
...
% implemented in the code *|<../../chebdoc/doc/cf_DOC.html cf>|* due to
...
% *|<../../chebdoc/doc/interp1_DOC.html interp1>|* command. For example, here is
...
% *|<../../chebdoc/doc/lebesgue_DOC.html lebesgue>|* for computing these functions.
...
%%
% We can use the command *|<../../chebdoc/doc/chebpade_DOC.html chebpade>|*, developed by
...
% interpolation is encoded in the command *|<../../chebdoc/doc/ratinterp_DOC.html ratinterp>|*,
...
% Section 4.6, are best approximants computed by *|<../../chebdoc/doc/remez_DOC.html remez>|* and
% Caratheodory-Fejer approximants computed by *|<../../chebdoc/doc/cf_DOC.html cf>|* [Trefethen & Gutknecht
