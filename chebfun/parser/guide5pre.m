...
% |<#MATLABDOC:axis axis equal>| command ensures that the real and
...
% An easier method is to use the *|<#CHEBDOC:chebjoin chebjoin>|* command,
% in which a construction like |<#CHEBDOC:chebjoin chebjoin>(f,g,h)|
...
% |<#CHEBDOC:chebjoin chebjoin>(f,g,h)| has three pieces with domains
...
% *|<#CHEBDOC:angle angle>|* and *|<#CHEBDOC:unwrap unwrap>|*:
...
%% 5.5 Alphabet soup
% The Chebfun command *|<#CHEBDOC:scribble scribble>|* returns a
