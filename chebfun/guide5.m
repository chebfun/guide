...
% An easier method is to use the "chebjoin" command, in which a
% construction like chebjoin(f,g,h) constructs a single chebfun with the same
% values as f, g, and h, but on a domain concatenated together.  Thus if
% the domains of f, g, h are [a,b], [c,d], and [e,d], then chebjoin(f,g,h) has
