...
%% 11.1  Trigonometric series and interpolants
...
%% 11.6 Trigonometric coefficients
...
% 11.1.  The function `trigcoeffs` provides this functionality.

%%
% As discussed in Section 11.1, the decay rate of the trigonometric
...
% in Section 11.1.  Also note that `trigcoeffs` by default returns the 
...
% Section 11.1.  This decay rate can be seen by plotting the
...
% integral formulas defined at the beginning of section 11.1 (with the actual
...
%% 11.7 Truncated trigonometric series approximations
